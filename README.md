# Tracks-Process-Integration-WhatsApp

**Proposta de Solução Arquitetural de Integração com o WhatsApp Business **
...
WhatsApp Business API / BSP 
  │ 
  ▼ 
Camada de Integração Conversacional 
(API Gateway / Webhooks / Orquestrador) 
  │ 
  ├──────────────► Plataforma Conversacional Itaú 
  │                   │ 
